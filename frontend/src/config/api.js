...
export const API_ENDPOINTS = {
  // Authentication endpoints - MongoDB Authentication
  AUTH: {
    REGISTER: `${API_CONFIG.BASE_URL}/auth/register`,
    LOGIN: `${API_CONFIG.BASE_URL}/auth/login`,              // MongoDB authentication login
    LOGOUT: `${API_CONFIG.BASE_URL}/auth/logout`,            // MongoDB authentication logout
